...
//         adapted from code by Chris Chafe (cc@ccrma)
//         and Hongchan Choi (hongchan@ccrma) 
// @desc Generates a windy sound based on (in this case)
//       direct guitar input via adc.
// @note amplitude/spectrum tracking using UAna ugens
//       original code was in amplitudeSpectrumTracker.ck
// @version chuck-1.3.1.3 / ma-0.2.2c
// @revision 1

// IMPORTANT NOTE: This patch is designed to use guitar input.
...
// for recording...
"tabla_wind.wav" => string filename;
WvOut w;
dac => w => blackhole;
